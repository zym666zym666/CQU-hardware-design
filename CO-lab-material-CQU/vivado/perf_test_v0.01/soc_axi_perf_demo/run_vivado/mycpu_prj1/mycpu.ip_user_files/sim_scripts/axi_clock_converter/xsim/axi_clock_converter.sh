...
#
# Script generated by Vivado on Wed Jan 01 12:38:49 +0800 2025
...
# script info
echo -e "axi_clock_converter.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axi_infrastructure_v1_1_0 -L fifo_generator_v13_2_8 -L axi_clock_converter_v2_1_27 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_clock_converter xil_defaultlib.axi_clock_converter xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="G:/vivado/Vivado/2023.1/data/xsim"
  fi
